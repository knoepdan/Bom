...
{
    [Route("/{" + Const.RouteArgumentNames.Lang + "}/{" + Const.RouteArgumentNames.Controller + "}/{" + Const.RouteArgumentNames.Action + "}")] // important to just have one route (otherwise wont work as fallback)
    [Controller]
